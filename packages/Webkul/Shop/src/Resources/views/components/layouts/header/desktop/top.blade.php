...
<v-topbar>
    <!-- Shimmer Effect -->
    <div class="flex items-center justify-between border border-b border-l-0 border-r-0 border-t-0 bg-brandNavy text-white px-16">
        <!-- Currencies -->
...
@pushOnce('scripts')
    ...
    >
        <div class="flex w-full items-center justify-between border border-b border-l-0 border-r-0 border-t-0 bg-brandNavy text-white px-16">
