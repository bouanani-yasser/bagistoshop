...
@pushOnce('scripts')
    ...
    >
        <transition-group
            ...
            class='fixed top-5 z-[10004] grid justify-items-end gap-2.5 max-sm:hidden ltr:right-5 rtl:left-5'
        >
        ...
        <transition-group
            ...
            class='fixed bottom-10 left-1/2 z-[10004] grid -translate-x-1/2 -translate-y-1/2 transform justify-items-center gap-2.5 sm:hidden'
        >
            <x-shop::flash-group.item />
        </transition-group>
    </script>
