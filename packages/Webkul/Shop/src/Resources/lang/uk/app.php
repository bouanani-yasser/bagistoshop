...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Копірайт 2026 - :current_year, Webkul Software (зареєстрована в Індії). Всі права захищені.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Авторське право 2026 - :current_year, Webkul Software (зареєстровано в Індії). Усі права захищені.',
                'locale'                 => 'Мова',
