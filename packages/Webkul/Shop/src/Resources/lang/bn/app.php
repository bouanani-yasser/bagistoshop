...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© কপিরাইট 2026 - :current_year, ওয়েবকুল সফটওয়্যার (ভারতে নিবন্ধিত)। সব অধিকার সংরক্ষিত।',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© কপিরাইট 2026 - :current_year, Webkul Software (ভারতে নিবন্ধিত)। সমস্ত অধিকার সংরক্ষিত।',
                'locale'                 => 'লোকেল',
