...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Prawa autorskie 2026 - :current_year, Webkul Software (zarejestrowane w Indiach). Wszelkie prawa zastrzeżone.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Prawa autorskie 2026 - :current_year, Webkul Software (zarejestrowane w Indiach). Wszelkie prawa zastrzeżone.',
                'locale'                 => 'Lokalizacja',
