...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Droits d’auteur 2026 - :current_year, Webkul Software (enregistré en Inde). Tous droits réservés.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Copyright 2026 - :current_year, AB Dentaire. Tous droits réservés.',
                'locale'                 => 'Langue',
    ...
    'home' => [
        ...
        'dental' => [
            'trusted-supplier'      => 'Votre Fournisseur Dentaire de Confiance',
            'hero-title'            => 'Équipements & Produits Dentaires Professionnels',
            'hero-description'      => 'Découvrez notre gamme complète d\'équipements et produits dentaires de haute qualité. Approuvé par les professionnels dentaires de toute la région.',
            ...
            'free-shipping-desc'    => 'Pour commandes +100€',
            'certified'             => 'Produits Certifiés',
            'certified-desc'        => 'Certifié ISO & CE',
            'support'               => 'Support 24/7',
            'support-desc'          => 'Assistance experte',
            'secure'                => 'Paiement Sécurisé',
            'secure-desc'           => 'Paiement 100% sécurisé',
            'our-categories'        => 'Nos Catégories',
            'categories-title'      => 'Acheter par Catégorie',
            'categories-subtitle'   => 'Parcourez notre large sélection d\'équipements et fournitures dentaires',
            'cat-instruments'       => 'Instruments',
            'cat-consumables'       => 'Consommables',
            'cat-imaging'           => 'Imagerie',
            'cat-hygiene'           => 'Hygiène',
            'cat-prosthetics'       => 'Prothèses',
            'cat-orthodontics'      => 'Orthodontie',
            ...
            'promo-equipment-title' => 'Derniers Équipements Dentaires',
            'promo-equipment-desc'  => 'Découvrez les dernières technologies et équipements dentaires pour votre cabinet.',
            'promo-consumables-title'=> 'Approvisionnez-vous & Économisez 20%',
            'promo-consumables-desc' => 'Consommables dentaires premium à des prix imbattables. Offre limitée !',
            'order-now'             => 'Commander Maintenant',
            'just-arrived'          => 'Vient d\'Arriver',
            'new-products'          => 'Nouveaux Produits',
            'view-all-new'          => 'Voir Tous les Nouveaux Produits',
            'why-us'                => 'Pourquoi Nous Choisir',
            'why-choose-title'      => 'Pourquoi les Professionnels Nous Font Confiance',
            'why-choose-subtitle'   => 'Nous nous engageons à fournir les meilleurs produits et services aux professionnels dentaires',
            'quality-title'         => 'Qualité Premium',
            'quality-desc'          => 'Tous les produits répondent aux normes internationales avec certification ISO et CE',
            'delivery-title'        => 'Livraison Rapide',
            'delivery-desc'         => 'Livraison rapide et fiable dans toute la région avec suivi',
            'expert-title'          => 'Support Expert',
            'expert-desc'           => 'Notre équipe d\'experts dentaires est disponible 24/7 pour vous assister',
            'price-title'           => 'Meilleurs Prix',
            'price-desc'            => 'Prix compétitifs avec offres exclusives pour les professionnels inscrits',
            'testimonials'          => 'Témoignages',
            'testimonials-title'    => 'Ce Que Disent Nos Clients',
            'testimonial-1'         => 'Produits de qualité excellente et livraison rapide. A.B DENTAIRE est devenu notre fournisseur principal pour tous les équipements dentaires.',
            'testimonial-2'         => 'Le service client est exceptionnel. Ils m\'ont aidé à choisir le bon équipement pour ma nouvelle clinique.',
            'testimonial-3'         => 'Nous commandons chez A.B DENTAIRE depuis 2 ans maintenant. Fiable, professionnel et super prix.',
            'dentist'               => 'Dentiste',
            'orthodontist'          => 'Orthodontiste',
            'clinic-name'           => 'Clinique Dental Care',
            'dental-clinic'         => 'Clinique Dentaire',
            'cta-title'             => 'Prêt à Améliorer Votre Cabinet ?',
            'cta-description'       => 'Rejoignez des milliers de professionnels dentaires qui nous font confiance pour leurs besoins en équipements et fournitures.',
            'create-account'        => 'Créer un Compte',
            'contact-us'            => 'Contactez-nous',
            'equipment'             => 'Équipements',
            'equipment-desc'        => 'Units & fauteuils dentaires professionnels',
            'consumables'           => 'Consommables',
            'consumables-desc'      => 'Matériaux de qualité pour usage quotidien',
            'imaging'               => 'Imagerie',
            'imaging-desc'          => 'Équipements de radiographie & diagnostic',
            'hygiene'               => 'Hygiène',
            'hygiene-desc'          => 'Stérilisation & produits de nettoyage',
        ],
